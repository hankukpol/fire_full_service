...
function formatExamType(type: ExamTypeValue): string {
  ...
  if (type === "CAREER_ACADEMIC") return "소방학과 경채";
...
export default function AdminSubmissionsPage() {
  ...
  useEffect(() => {
    if (!careerExamEnabled && (selectedExamType === "CAREER_RESCUE" || selectedExamType === "CAREER_ACADEMIC" || selectedExamType === "CAREER_EMT")) {
      setSelectedExamType("");
    }
        ...
        >
          ...
          {careerExamEnabled ? (
            <>
              ...
              <option value="CAREER_ACADEMIC">소방학과 경채</option>
